...
class AI21Segmentation:
    ...
    def segment_text(text):
        ...
        headers = {
            ...
            "Authorization": "Bearer <your_AI21lab_key>"
        }
...
Relevant Segments:"""
    ...
    def process_pdf_and_get_answer(self, pdf_path, question):
        questions_data = self.redis_client.get(pdf_path)

        if questions_data is None:
            questions_data = self.process_pdf(pdf_path)
            self.redis_client.set(pdf_path, json.dumps(questions_data))
        else:
